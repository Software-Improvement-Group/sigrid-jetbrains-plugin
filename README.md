...
- **Jira integration** — create a Jira issue from any selected finding via the toolbar button or right-click context menu; a dialog lets you review and edit the pre-filled summary and description before submitting.
